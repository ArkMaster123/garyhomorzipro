  ...
  const mockSearchResults = [
    {
      ...
      description:
        'Comprehensive guide to scaling businesses in the current market',
      quote:
        'Companies that focus on customer retention see 25% higher revenue growth',
    },
    {
      ...
      quote:
        'Digital transformation investments increased by 40% year-over-year',
    },
    {
