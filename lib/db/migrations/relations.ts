...
import { user, suggestion, document, chat, message, messageV2, stream, adminUser, knowledgeBase, knowledgeChunk, vote, voteV2 } from "./schema";
...
export const knowledgeChunkRelations = relations(knowledgeChunk, ({one}) => ({
	knowledgeBase: one(knowledgeBase, {
		fields: [knowledgeChunk.knowledgeBaseId],
